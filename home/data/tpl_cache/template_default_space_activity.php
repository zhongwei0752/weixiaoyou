<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_activity|template/default/header|template/default/footer', '1392100749', 'template/default/space_activity');?><!DOCTYPE html>
<html lang="en">
<head>
<title>微校友</title>
<meta charset="UTF-8" />
    ...
    <div class="span8">
      ...
      <div id="activity<?=$value['id']?>" class="widget-box">
        <div class="widget-title bg_ly" data-toggle="collapse" href="#<?=$value['id']?>"><span class="icon"><i class="icon-chevron-down"></i></span>
          ...
          <h5 id="subject<?=$value['id']?>"><?=$value['subject']?></h5>
           ...
           <div class="widget-content tab-content" style="padding: 0px;height:500px;">
            <div id="tab1" class="tab-pane active">
                <div class="modal-header">
                 ...
                 <div style="width:100%;height:400px;">
                  <div class="modal-body" style="text-align:center;overflow-y:hidden;float:left;width:500px;padding:0px;margin-top:10px;border-right:1px solid #CDCDCD;">
                    <p>活动标题：<input style="margin-left:6px;" type="text"  name="subject" id="resubject<?=$value['id']?>" value="<?=$value['subject']?>"></p>
                    ...
                    截止时间：<input class="form-control" size="12" style="width:209px;margin-left:10px;" id="retime<?=$value['id']?>" type="text" value="<?php echo sgmdate('y-m-d H:i',$value[time]); ?>"  readonly>
                ...
                <p>备&nbsp;&nbsp;&nbsp;&nbsp;注：<textarea style="margin-left:6px;width:208px;" rows="5" cols="10" name="message" id="remessage<?=$value['id']?>" ><?=$value['message']?></textarea></p>
                   ...
                   <div style="padding-top:20%;"><img src="" id="optionimga_" style="display:none;float:left"/>
                   </div>
                   </div>
                 </div>
            </div>
